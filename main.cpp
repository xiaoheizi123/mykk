...
int main(int argc, char* argv[]){
    ...
    // Path to list.txt
	ifstream listFile;
	string fileName = "../resource/images1.txt";
  	listFile.open(fileName);


  	// Read groundtruth for the 1st frame
  	ifstream groundtruthFile;
	string groundtruth = "../resource/groundtruth1.txt";
	...
	string listFrames = "../resource/images1.txt";
	...
	string resultsPath = "../resource/output.txt";
